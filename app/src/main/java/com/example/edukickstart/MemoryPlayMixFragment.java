 ...
 * Use the {@link MemoryPlayMixFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MemoryPlayMixFragment extends Fragment {

    public MemoryPlayMixFragment() {
        // Required empty public constructor
    }

    public static MemoryPlayMixFragment newInstance() {
        return new MemoryPlayMixFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_memory_play_mix, container, false);
        ...
        fadeOut2.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                requireActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.memory_play_fragment_container, MemoryPlayDigitsFragment.newInstance(true, 0, 0, 60000))
                        .commit();
            }
