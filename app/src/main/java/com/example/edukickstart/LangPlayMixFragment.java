 ...
 * Use the {@link LangPlayMixFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LangPlayMixFragment extends Fragment {

    public LangPlayMixFragment() {
        // Required empty public constructor
    }

    public static LangPlayMixFragment newInstance() {
        return new LangPlayMixFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lang_play_mix, container, false);
        ...
        fadeOut2.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                requireActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.lang_play_fragment_container, LangPlayWordsFragment.newInstance(true, 0, 0, 60000))
                        .commit();
            }
