 ...
 * Use the {@link TimePlayMixFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TimePlayMixFragment extends Fragment {

    public TimePlayMixFragment() {
        // Required empty public constructor
    }

    public static TimePlayMixFragment newInstance() {
        return new TimePlayMixFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_time_play_mix, container, false);
        ...
        fadeOut2.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                requireActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.time_play_fragment_container, TimePlayClocksFragment.newInstance(true, 0, 0, 60000))
                        .commit();
            }
