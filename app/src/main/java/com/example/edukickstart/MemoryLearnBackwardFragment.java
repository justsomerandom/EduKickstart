...
public class MemoryLearnBackwardFragment extends Fragment {
    ...
    private static final int DATABASE_INDEX = 6;

    public MemoryLearnBackwardFragment() {
        // Required empty public constructor
    }

    public static MemoryLearnBackwardFragment newInstance() {
        return new MemoryLearnBackwardFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_memory_learn_backward, container, false);
