...
public class MathPlayMixFragment extends Fragment {

    public MathPlayMixFragment() {
        // Required empty public constructor
    }

    public static MathPlayMixFragment newInstance() {
        return new MathPlayMixFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_math_play_mix, container, false);
                ...
                switch (new Random().nextInt(3)) {
                    case 0:
                        requireActivity().getSupportFragmentManager().beginTransaction()
                            .replace(R.id.math_play_fragment_container, MathPlayAddFragment.newInstance(true, 0, 0, 60000))
                            .commit();
                        break;
                    case 1:
                        requireActivity().getSupportFragmentManager().beginTransaction()
                                .replace(R.id.math_play_fragment_container, MathPlaySubFragment.newInstance(true, 0, 0, 60000))
                                .commit();
                        break;
                    case 2:
                        requireActivity().getSupportFragmentManager().beginTransaction()
                                .replace(R.id.math_play_fragment_container, MathPlayMultiplyFragment.newInstance(true, 0, 0, 60000))
                                .commit();
                        break;
                }
            }
